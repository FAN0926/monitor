...
def split_time(time_sq):
    start_time = time_sq.pop(0)
    end_time = time_sq.pop(0)
    return start_time,end_time

if __name__ == '__main__':
    papa = pd.read_csv(r'F:\OneDrive - bupt.edu.cn\PycharmProjects\python_foundation\Opencv\result\A ISVID_20191012_191644_1.txt', sep='\t',
    ...
    for row in papa.itertuples(index=True, name='Pandas'):
